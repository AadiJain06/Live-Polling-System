          ...
          <OptionsContainer>
            {poll.options.map((option, index) => (
              <OptionButton
                ...
                whileTap={{ scale: 0.98 }}
                style={{
                  borderColor: selectedOptions.includes(option) ? 'var(--primary-purple)' : 'var(--border)',
                  background: selectedOptions.includes(option) ? 'var(--surface)' : 'var(--surface)'
                }}
              >
                <OptionNumber selected={selectedOptions.includes(option)}>
                  {getOptionNumber(index)}
                </OptionNumber>
                <OptionText selected={selectedOptions.includes(option)}>
                  {option}
                </OptionText>
          ...
          <OptionsContainer>
            {poll.options.map((option, index) => (
              <OptionButton
                ...
                whileTap={{ scale: 0.98 }}
                style={{
                  borderColor: selectedOption === option ? 'var(--primary-purple)' : 'var(--border)',
                  background: selectedOption === option ? 'var(--surface)' : 'var(--surface)'
                }}
              >
                <OptionNumber selected={selectedOption === option}>
                  {getOptionNumber(index)}
                </OptionNumber>
